...
const { addBookValidation, editBookValidation } = require('./validations');
...
module.exports = {
  addBooksHandler, getAllBooksHandler, getBookByIdHandler, editBookByIdHandler, deleteBookByIdHandler, indexHandler,
};
